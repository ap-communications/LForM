...
curl --cacert /etc/kibana/certs/elasticsearch-ca.pem -u elastic:$PASS -H "kbn-xsrf: reporting" -H 'Content-Type: application/json' -X PUT "http://localhost:5601/api/spaces/space/default" -d '
{
"id": "default",
"name": "Default",
